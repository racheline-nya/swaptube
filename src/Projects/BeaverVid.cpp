...
------  structure of 2swap's videos  ------
- start with a cool visual showcase of something that isn't precisely explained yet, but with a vaguely comprehensible statement that it's supposed to demonstrate. to get the viewer subconsciously interested. something like:
--- "you are looking at every possible computer program" with a super deep zoom into the 3d TNF thing
--- "this beaver is building the largest possible dam" with a video of the bb4 or bb5 champion rendered with some cute beaver and log pictures
- some elaboration or followup that gets the viewer consciously interested
--- "You are looking at every possible computer program. [pause] This program just loops forever. This one makes a pretty fractal pattern. This one out here counts in binary. And that program there... is one of the smallest open problems in math." as the zoom focuses on appropriate cuboids, while on the side we show their space-time diagrams evolving. maybe we pick the machines to all be close to each other, so that the zooms after the initial visual hook aren't too overwhelming.
--- "This beaver is building the largest possible dam. [pause] The restriction is that it follows very simple rules. It can only move left and right-" ok this sucks tbh



draft 0:

"You are looking at every possible computer program." (super deep zoom into 3d TNF grid, close to the BB(3,3) probable champion, while showing the space-time diagram evolving on the side)
"This program just loops forever to the right." (zoom in on 1RB2LA1RC_2LC---2RB_2LA0LB0RA and let the space-time diagram evolve to show the TCing)
"This one bounces from side to side." (zoom in on 1RB0LB1RC_2LC---2RB_2LA0LB0RA)
~~"This one does some weird stuff for a while before it starts to bounce" (zoom in on 1RB1LA1RC_2LC2LC2RB_2LA0LB0RA)~~ probably skip this
"This one..." (zoom in on 1RB2LC1RC_2LC---2RB_2LA0LB0RA, the probviously halting champion) "Hmm, what's going on here? Let's zoom out is one of the smallest open problems in math." as the zoom focuses on appropriate cuboids, while on the side we show their space-time diagrams evolving. maybe we pick the machines to all be close to each other, so that the zooms after the initial visual hook aren't too overwhelming.
...
"or bounce from side to side." (zoom out and in on a bouncer)
"Some count to infinity, usually in binary" (zoom in on a binary counter)
"But occasionally, you might stumble upon Cryptids, the lovecraftian machines that stand firmly between us and a complete understanding of mathematics" (zoom in on hydra, while some spooky visual effects creep in from the edges and spooky audio effects fade in as well and maybe the 3d TNF grid "glitches out" with hydra's children blinking into and out of existence)

[[[Introduction Chapter]]]
"But what even is a computer program? David Hilbert, one of the greatest mathematicians of the 1900s, wanted to know whether there was an algorithm which can determine whether any given mathematical statement is true or false." (same animations as in the lambda video)
"In a previous video, we looked at Alonzo Church's answer to this question," (alonzo church appears in the bottom left corner as in the lambda video, while the bottom right shows lambda expressions reducing etc)
"but two others independently came to the same conclusion through different paths." (lambda stuff is replaced with turing and godel)
"One of those paths led to the creation of the field of computer science as we know it. This video is about Alan Turing's solution to Hilbert's problem: Turing machines." (zoom in on turing and then replace him with a turing machine in its starting position)
"They follow simple instructions. They move through an infinite tape, reading and writing and keeping track of their internal state." (the machine's state is highlighted)
"Let's look at one. Here are its instructions." (the table shows up)
"It starts in state A and reads 0, so its instructions tell it to write 1, go right, and switch to state B" (the various instructions are highlighted in the table while being performed)
"Now it's in state B and reads 0, so its instructions tell it to write 1, go left, and switch back to state A" (again but faster)
"After a few more steps, it reads 1 in state B, and its instructions tell it to write 1, go right, and stop. "
